...
<br>
<p align="center">
	<h3>For all the Show/See request(Method="GET"), you can get it in pages and can order it(Default-> name/id). For pagination and sorting in Get method endpoints you have to add the thing which are as follows...</h3>
